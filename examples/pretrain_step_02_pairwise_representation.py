...
if __name__ == "__main__":
    ...
    if args.use_AMP:
        protein_repr_array, description_repr_array, protein_seq_list, text_seq_list = extract_AMP(dataloader)
    else:
        protein_repr_array, description_repr_array, protein_seq_list, text_seq_list = extract(dataloader)
    ...
    saved_file_path = os.path.join(output_folder, "pairwise_representation")
    np.savez(saved_file_path, protein_repr_array=protein_repr_array, description_repr_array=description_repr_array)
